...
public class Tree {
	...
	public void click_Overview_of_trees() {
		OVERVIEW_OF_TREES_LK.click();
	}

	public void click_Terminoloies() {
		TERMINOLOGIES_LK.click();
	}

	public void click_TypesOfTrees() {
		TYPES_OF_TREES_LK.click();
	}

	public void click_TreeTraversals() {
		TREE_TRAVERSALS_LK.click();
	}

	public void click_TraversalsIllustrations() {
		TRAVERSALS_ILLUSTRATION_LK.click();
	}

	public void click_BinaryTree() {
		BINARY_TREE_LK.click();
	}
	...
	public void click_ImplementationInPython() {
		IMPLEMENTATION_IN_PYTHON_LK.click();
	}
	...
	public void click_ApplicationsofBinaryTree() {
		APPLICATIONS_OF_BINARY_TREE_LK.click();
	}
	...
	public boolean Validate_OverviewOfTreePage() {
		result = tdriver.getCurrentUrl().contains(constants.OVERVIEW_OF_TREE_URL);
		return result;
	}

	public boolean Validate_TerminologiesPage() {
		result = tdriver.getCurrentUrl().contains(constants.TERMINOLOGIES_URL);
		return result;
	}

	public boolean Validate_TypesofTreesPage() {
		result = tdriver.getCurrentUrl().contains(constants.TYPES_OF_TREES_URL);
		return result;
	}

	public boolean Validate_TreeTraversalsPage() {
		result = tdriver.getCurrentUrl().contains(constants.TREE_TRAVERSALS_URL);
		return result;
	}

	public boolean Validate_TraversalsIllustrationPage() {
		result = tdriver.getCurrentUrl().contains(constants.TRAVERSALS_ILLUSTRATION_URL);

		return result;
	}

	public boolean Validate_BinaryTreePage() {
		result = tdriver.getCurrentUrl().contains(constants.BINARY_TREE_URL);
		return result;
	}

	public boolean Validate_TypesOfBinaryTreePage() {
		result = tdriver.getCurrentUrl().contains(constants.TYPES_OF_BINARY_TREE_URL);
		return result;
	}

	public boolean Validate_ImplementationInPythonPage() {
		result = tdriver.getCurrentUrl().contains(constants.IMPLEMENTATION_IN_PYTHON_URL);
		return result;
	}

	public boolean Validate_BinaryTreeTraversalsPage() {
		result = tdriver.getCurrentUrl().contains(constants.BINARY_TREE_TRAVERSALS_URL);
		return result;
	}

	public boolean Validate_ImplementationOfBinaryTreesPage() {
		result = tdriver.getCurrentUrl().contains(constants.IMPLEMENTATION_OF_BINARY_TREES_URL);
		return result;
	}

	public boolean Validate_ApplicationOfBinaryTreesPage() {
		result = tdriver.getCurrentUrl().contains(constants.APPLICATIONS_OF_BINARY_TREES_URL);
		return result;
	}

	public boolean Validate_BinarySearchTreePage() {
		result = tdriver.getCurrentUrl().contains(constants.BINARY_SEARCH_TREE_URL);
		return result;
	}

	public boolean Validate_ImplementationOfBST() {
		result = tdriver.getCurrentUrl().contains(constants.IMPLEMENTATION_OF_BST_URL);
		return result;
	}
